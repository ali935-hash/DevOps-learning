...
Never commit real credentials, private keys, API keys, tokens, or other sensitive information to a public GitHub repository.

---

## 🚀 Continuing the Journey

This repository will continue to document my progress through the Bandit wargame, with an emphasis on understanding **why** each solution works rather than simply copying commands.
